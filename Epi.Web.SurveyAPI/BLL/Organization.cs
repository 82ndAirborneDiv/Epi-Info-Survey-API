...
namespace Epi.Web.SurveyAPI.BLL
{
    ...
    {
        private Interfaces.DataInterfaces.IOrganizationDao OrganizationDao;

        public Organization(Interfaces.DataInterfaces.IOrganizationDao pOrganizationDao)
        {
        ...
        public List<OrganizationBO> GetOrganizationKey(string OrganizationName)
        {
            ...
            foreach (OrganizationBO _result in result)
            {
                ...
                _result.OrganizationKey = Cryptography.Decrypt(_result.OrganizationKey);
        ...
        {
            OrganizationBO.OrganizationKey = Cryptography.Encrypt(OrganizationBO.OrganizationKey);
